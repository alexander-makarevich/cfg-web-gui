...
export const CONFIG_DATA: Configuration[] = [
  ...
  {ip: '192.168.3.1', type: 'Backup' , capturedOn: '2019-05-01', version: '1', associatedLabel: null            , commands: commands05},
  {ip: '192.168.3.1', type: 'Running', capturedOn: '2019-06-01', version: '2', associatedLabel: 'Baseline'      , commands: commands06},
  {ip: '192.168.3.2', type: 'Backup' , capturedOn: '2019-05-01', version: '1', associatedLabel: null            , commands: commands05},
  {ip: '192.168.3.2', type: 'Running', capturedOn: '2019-06-01', version: '2', associatedLabel: 'Baseline'      , commands: commands06},
  {ip: '192.168.3.3', type: 'Running', capturedOn: '2019-05-01', version: '1', associatedLabel: null            , commands: commands05},
  {ip: '192.168.3.4', type: 'Running', capturedOn: '2019-05-01', version: '1', associatedLabel: 'Baseline'      , commands: commands05},
  {ip: '192.168.3.5', type: 'Running', capturedOn: '2019-05-01', version: '1', associatedLabel: 'Stable_config' , commands: commands05},
  {ip: '192.168.3.6', type: 'Running', capturedOn: '2019-05-01', version: '1', associatedLabel: 'Baseline'      , commands: commands05},
  {ip: '192.168.3.7', type: 'Running', capturedOn: '2019-05-01', version: '1', associatedLabel: null            , commands: commands05},
  {ip: '192.168.3.8', type: 'Running', capturedOn: '2019-05-01', version: '1', associatedLabel: 'Baseline'      , commands: commands05},
